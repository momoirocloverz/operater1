<template>
    <div class="class-view" v-loading="loading" element-loading-text="正在请求中...">
        <div class="topCon">
            <div class="topFirst">
                <div>
        ...
        <div class="bottomCon">
            <div class="tableCon">
                <el-table :data="tableData" height="530" stripe style="width: 100%">
                    ...
                    <el-table-column label="操作" v-if="AuthBoolean('628')">
                        <template v-slot="scope">
                            <el-button size="mini" type="text" v-Auth="'628'" @click="handleEdit(scope.row,'1')">详情</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
